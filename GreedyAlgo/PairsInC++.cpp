...
bool compare(pair<int, int> p1, pair<int, int> p2)
{
    ...
    // return p1.first < p2.first;  // Sort by start time in ascending order
    // return p1.second > p2.second;  // Sort by end time in descending order
    // return p1.first > p2.first;  // Sort by start time in descending order
}
